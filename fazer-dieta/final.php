...
<script type="c0630722199f150a42e58da2-text/javascript">var createDietUserUrl = "\/profiles\/create";</script>
    ...
    <div class="row text-center ">
        ...
        <div class="summary-blocks">
            <div class="summary-block text-left">
                ...
                <div class="info">
                    <div class="summary-header"><h2>Calorias Diárias</h2></div>
                    ...
                    <div class="summary-summary text-center">Calorias Recomendada:<p
                                class="blue-gradient-text">2800&nbsp;-&nbsp;2900</p></div>
                </div>
            ...
            <div class="summary-block text-left">
                <div class="summary-info"><a href="javascript:void(0);"></a></div>
                <div class="info">
                    <div class="summary-header"><h2>Gorduras</h2></div>
                    <div class="summary-diagramm text-center">
                        <div class="violet-round-diagram round-diagram">
                            <div class="violet-gradient-text bottom-centered">220&nbsp;-&nbsp;240g
                                <p>Gorduras</p>
                            </div>
                        </div>
                        <div class="diagram-range">
                    ...
                    <div class="summary-summary text-center"> Gorduras Recomendada:<p
                                class="violet-gradient-text">220&nbsp;-&nbsp;240g</p></div>
                </div>
                <div class="help">Com uma dieta ceto, as gorduras são mantidas ALTAS. Ao manter as gorduras e os carboidratos baixos, forçamos seu corpo a começar a usar FAT para combustível. A gordura se torna a nova fonte de energia do seu corpo e você se torna muito mais eficiente em queimá-la assim
            ...
            <div class="summary-block text-left">
                <div class="summary-info"><a href="javascript:void(0);"></a></div>
                <div class="info">
                    <div class="summary-header"><h2>Proteína Diária</h2></div>
                    <div class="summary-diagramm text-center">
                        <div class="green-round-diagram round-diagram">
                            <div class="green-gradient-text bottom-centered">170&nbsp;-&nbsp;190g
                                <p>Proteína</p></div>
                    ...
                    <div class="summary-summary text-center">Proteína Recomendada:<p
                                class="green-gradient-text">170&nbsp;-&nbsp;190g</p></div>
                </div>
                <div class="help">
            ...
            <div class="summary-block text-left">
                <div class="summary-info"><a href="javascript:void(0);"></a></div>
                <div class="info">
                    <div class="summary-header"><h2>Carboidratos diários</h2></div>
                    <div class="summary-diagramm text-center">
                        <div class="yellow-round-diagram round-diagram">
                            <div class="yellow-gradient-text bottom-centered">40&nbsp;-&nbsp;50g
                                <p>Carboidratos</p></div>
                    ...
                    <div class="summary-summary text-center">Carboidratos Recomendada:<p
                                class="yellow-gradient-text">40&nbsp;-&nbsp;50g</p></div>
                </div>
                <div class="help">
            ...
            <div class="summary-block text-left">
                <div class="summary-info"><a href="javascript:void(0);"></a></div>
                <div class="info">
                    <div class="summary-header"><h2>Ingestão Diária de Água</h2></div>
                    <div class="summary-diagramm text-center">
                        <div class="water-diagram round-diagram">
                            <div class="water-centered">5.2L
                            </div>
                        </div>
                        <div class="diagram-range">
                    ...
                    <div class="summary-summary text-center">Água Recomendada:<p
                                class="red-gradient-text">5.2L</p></div>
                </div>
                <div class="help">
            ...
            <div class="summary-block text-left">
                <div class="summary-info"><a href="javascript:void(0);"></a></div>
                <div class="info">
                    <div class="summary-header"><h2>Seu IMC</h2></div>
                    <div class="summary-diagramm text-center">
                        <div class="bmi-diagram Obese round-diagram">
                            <div class="blue-gradient-text bmi-centered">37.0                            </div>

                        </div>

                        <div class="clear"></div>
                    </div>
                    <div class="summary-summary text-center">Seu IMC:<p
                                class="blue-gradient-text">Obesa</p></div>
                </div>
                <div class="help">
            ...
            <div class="summary-block text-left">
                <div class="summary-info"><a href="javascript:void(0);"></a></div>
                <div class="info">
                    <div class="summary-header"><h2>Nível de atividade diária</h2></div>
                    <div class="summary-diagramm text-center">
            ...
            <div class="summary-block text-left">
                <div class="summary-info"><a href="javascript:void(0);"></a></div>
                <div class="info">
                    <div class="summary-header"><h2>Peso alcançável de 30 dias</h2></div>
                    <div class="summary-diagramm text-center">
                    ...
                    <div class="summary-summary text-center">Peso alcançável:<p
                                class="lgrn-gradient-text">
                            115 kg</p>
                    </div>
                </div>
        ...
        <div class="what-you-get-blocks">
            ...
            <div class="wyg-block col-md-6 ">
                ...
                <div class="m-item-reason o-section-benefits__reason">
                    <img data-src="https://assets.appsforfit.com/assets/img/keto/icons/reason-1.svg"
                         class="a-icon m-item-reason__icon"
                         src="https://assets.appsforfit.com/assets/img/keto/icons/reason-1.svg"
                         style="visibility: visible;">
                    <div class="m-item-reason__text">Os tamanhos das porções foram calculados especificamente para você</div>
                </div>
                <div class="m-item-reason o-section-benefits__reason">
                    <img data-src="https://assets.appsforfit.com/assets/img/keto/icons/reason-2.svg"
                         class="a-icon m-item-reason__icon"
                         src="https://assets.appsforfit.com/assets/img/keto/icons/reason-2.svg"
                         style="visibility: visible;">
                    <div class="m-item-reason__text">A dieta ceto mais popular</div>
                </div>
                <div class="m-item-reason o-section-benefits__reason">
                    <img data-src="https://assets.appsforfit.com/assets/img/keto/icons/reason-3.svg"
                         class="a-icon m-item-reason__icon"
                         src="https://assets.appsforfit.com/assets/img/keto/icons/reason-3.svg"
                         style="visibility: visible;">
...
<script type="c0630722199f150a42e58da2-text/javascript">jQuery(function ($) {
...
});</script><script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c0630722199f150a42e58da2-|49" defer=""></script></body>
</html>
    <?php endif; ?>
<?php endif; ?>